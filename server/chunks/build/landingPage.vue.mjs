import { c as useLocale, t as tv, f as reactiveOmit, b as _appConfig, P as PrivateApiUrl, g as useToast, n as navigateTo, e as __nuxt_component_2 } from './server.mjs';
import { U as UBadge } from './Badge.vue.mjs';
import { _ as __nuxt_component_1 } from './DropdownMenu.vue.mjs';
import { defineComponent, mergeModels, useSlots, computed, useModel, unref, mergeProps, withCtx, createVNode, createBlock, createCommentVNode, openBlock, renderSlot, createTextVNode, toDisplayString, Fragment, renderList, useSSRContext, withAsyncContext, useTemplateRef, h } from 'vue';
...
const useLandingPageApi = {
  create: async (payload) => await useRequestApi(PrivateApiUrl.LandingPageCreate, {
    method: "POST",
    server: false,
    lazy: true,
    immediate: false,
        ...
        cell: ({ row }) => {
          const items = [
            ...
            },
            {
              ...
              onSelect() {
                (void 0).clipboard.writeText(row.original._id);
                toast.add({
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/C/landingPage.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=landingPage.vue.mjs.map
